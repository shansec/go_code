...
const (
	Gateway_SayHello_FullMethodName = "/gateway.Gateway/SayHello"
)
...
func (c *gatewayClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
...
func (UnimplementedGatewayServer) SayHello(context.Context, *HelloRequest) (*HelloResponse, error) {
